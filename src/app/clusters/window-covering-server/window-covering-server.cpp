...
//  ZCL_WC_TARGET_POSITION_LIFT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID (0x000B)
//  ZCL_WC_TARGET_POSITION_TILT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID (0x000C)
//  ZCL_WC_END_PRODUCT_TYPE_ATTRIBUTE_ID (0x000D)
//  ZCL_WC_CURRENT_POSITION_LIFT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID (0x000E)
//  ZCL_WC_CURRENT_POSITION_TILT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID (0x000F)
...
{
    return emberAfWcWriteAttribute(ep, ZCL_WC_TARGET_POSITION_LIFT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID, (uint8_t *) &value, ZCL_INT16U_ATTRIBUTE_TYPE);
}

EmberAfStatus emberAfWcSetTargetPositionTilt(EndpointId ep, uint16_t value)
{
    return emberAfWcWriteAttribute(ep, ZCL_WC_TARGET_POSITION_TILT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID, (uint8_t *) &value, ZCL_INT16U_ATTRIBUTE_TYPE);
}

EmberAfStatus emberAfWcGetTargetPositionLift(EndpointId ep, uint8_t * dataPtr, uint16_t readLength)
{
    return emberAfWcReadAttribute(ep, ZCL_WC_TARGET_POSITION_LIFT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID, dataPtr, readLength);
}

EmberAfStatus emberAfWcGetTargetPositionTilt(EndpointId ep, uint8_t * dataPtr, uint16_t readLength)
{
    return emberAfWcReadAttribute(ep, ZCL_WC_TARGET_POSITION_TILT_ACCURATE_PERCENTAGE_ATTRIBUTE_ID, dataPtr, readLength);
}
...
{
    emberAfWindowCoveringClusterPrint("Window Up Open command received");

    EmberAfStatus status = emberAfWindowCoveringClusterSetValueCallback(emberAfCurrentEndpoint(), ZCL_WC_UP_OR_OPEN_COMMAND_ID);
...
{
    emberAfWindowCoveringClusterPrint("Window Down Close command received");

    EmberAfStatus status = emberAfWindowCoveringClusterSetValueCallback(emberAfCurrentEndpoint(), ZCL_WC_DOWN_OR_CLOSE_COMMAND_ID);
    emberAfSendImmediateDefaultResponse(status);
    return true;
}
...
{
    emberAfWindowCoveringClusterPrint("Window Stop command received");

    EmberAfStatus status = emberAfWindowCoveringClusterSetValueCallback(emberAfCurrentEndpoint(), ZCL_WC_STOP_COMMAND_ID);
    emberAfSendImmediateDefaultResponse(status);
...
{
    EmberAfStatus status = EMBER_ZCL_STATUS_SUCCESS;
    emberAfWindowCoveringClusterPrint("Window Go To Lift Percentage command received");
...
{
    EmberAfStatus status = EMBER_ZCL_STATUS_SUCCESS;
    emberAfWindowCoveringClusterPrint("Window Go To Lift Value command received");
...
{
    EmberAfStatus status = EMBER_ZCL_STATUS_SUCCESS;
    emberAfWindowCoveringClusterPrint("Window Go To Tilt Percentage command received");
...
{
    EmberAfStatus status = EMBER_ZCL_STATUS_SUCCESS;
    emberAfWindowCoveringClusterPrint("Window Go To Tilt Value command received");
