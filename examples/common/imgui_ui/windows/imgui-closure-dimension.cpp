...
#include "imgui-closure-dimension.h"
...
static void DisplayFeature(const uint32_t & featureMap, ClosureDimension::Feature aFeature)
{
...
void ImGuiClosureDimension::Render()
{
    ImGui::Begin("Closure Dimension Cluster(S)");
    ImGui::Separator();
    ImGui::Text("Closure %s Dimension Cluster Ep[%d] ", mName, mEndpointId);
...
void ImGuiClosureDimension::UpdateState()
{
