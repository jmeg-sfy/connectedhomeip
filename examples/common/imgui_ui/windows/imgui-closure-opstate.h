...
/**
 * Assumes ImGuiClosureOpState on a given endpoint with FULL support (on/off, level and color)
 */
class ImGuiClosureOpState : public Window
{
public:
    ImGuiClosureOpState(chip::EndpointId aEndpointId, const char * aName, uint32_t aFeature) : 
